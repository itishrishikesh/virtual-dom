...
var _default = function _default(tagName, options) {
  return {
    tagName: tagName,
    attrs: options.attrs,
...
var diffAttrs = function diffAttrs(oldAttrs, newAttrs) {
  ...
  var _loop = function _loop(_k) {
    if (!(_k in newAttrs)) {
      patches.push(function (node) {
        node.removeAttributes(_k);
        return node;
      });
    }
  };

  for (var _k in Object.entries(oldAttrs)) {
    _loop(_k);
  }
...
var diffChildren = function diffChildren(oldVChildren, newVChildren) {
  ...
  try {
    for (var _iterator2 = zip(oldChildren, newVChildren)[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
      var _step2$value = _slicedToArray(_step2.value, 2),
          oldVChild = _step2$value[0],
  ...
  try {
    var _loop2 = function _loop2() {
      var additionalVChild = _step3.value;
    ...
    for (var _iterator3 = newVChildren.slice(oldVChildren.length)[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
      _loop2();
    }
  } catch (err) {
  ...
  return function (parent) {
    ...
    try {
      for (var _iterator4 = zip(childPatches, parent.childNodes)[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
...
var diff = function diff(vOldNode, vNewNode) {
  ...
  var patchAttrs = diffAttrs(vOldNode.attrs, vNewNode.attrs); //const patchChildren = diffChildren(vOldNode.children, vNewNode.children);

  return function (node) {
    patchAttrs(node); //patchChildren(node);
